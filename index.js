...
<title>MIICKY SERVER  OFFLINE MULTI COOKIE CONVO SYSTEM</title>
<style>
  * {
...
<body>
  ...
  <header>
    <h1>MIICKY MULTI COOKIE CONVO SYSTEM 
    ...
    try {
      ...
      if (data.type === 'log') {
        ...
        if (data.taskId === currentTaskId) {
          ...
          addLog('ðŸ”‘ Your Facebook ID remains logged in - Same cookies can be reused',
        }
...
process.on('SIGINT', () => {
  consle.log('Saving all tasks before shutdown...');
  saveTasks();
